...
class CrudLanding
{
     ...
     */
    /*
    * Funcion para crear landing con 12 secciones
    */
    public function CreateLanding($rootValue, array $args, GraphQLContext $context, ResolveInfo $resolveInfo)
    {
        //guardar datos de la landing
        DB::table('landing')->where('producto_id',$args['tipo'])->update([
            'seccion1'=>\json_encode($args['seccion1Input']),
            'seccion2'=>\json_encode($args['seccion2Input']),
            'seccion3'=>\json_encode($args['seccion3Input']),
            'seccion4'=>\json_encode($args['seccion4Input']),
            'seccion5'=>\json_encode($args['seccion5Input']),
            'seccion6'=>\json_encode($args['seccion6Input']),
            'seccion7'=>\json_encode($args['seccion7Input']),
            'seccion8'=>\json_encode($args['seccion8Input']),
            'seccion9'=>\json_encode($args['seccion9Input']),
            'seccion10'=>\json_encode($args['seccion10Input']),
            'seccion11'=>\json_encode($args['seccion11Input']),
            'seccion12'=>\json_encode($args['seccion12Input']),
            'producto_id'=>$args['tipo']
        ]);
        // recuperar datos de la landing
